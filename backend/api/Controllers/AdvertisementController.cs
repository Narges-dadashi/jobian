...
//         {
//             string? userName = await memberRepository.GetUserNameByIdAsync(advertisement.CreatorId!, cancellationToken);

//             AdvertisementResponseDto advertisementResponseDto = Mappers.ConvertAdvertisementToAdvertisementResponseDto(advertisement, userName!);
